...
golden_standard_path = 'golden_standard/golden_standard_final.txt'
fasttext_model_eval_path = 'fasttext/fasttext_w2v_estimations.txt'
united_w2v_model_eval_path = 'w2v_model_estimations_crf.txt' #'w2v_model_estimations_morfessor.txt'

with open('oov_words_intersected.txt', encoding='utf-8') as oov_opener:
