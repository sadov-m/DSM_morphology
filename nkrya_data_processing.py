...
with open('C:/Users/Ольга/Downloads/data.txt', 'w', encoding='utf-8') as writer: # output file

    with open('C:/Users/Ольга/Downloads/ruscorpora_lemmatized.json', encoding='utf-8') as json_opener: #input json file
